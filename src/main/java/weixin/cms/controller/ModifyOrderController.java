...
public class ModifyOrderController {
    ...
    public void getAllOrder(HttpServletRequest request,
        ...
        if ("0".equals(class_type)|| StringUtils.isEmpty(class_type)) {
            ...
            //有类型筛选
            sql = " where payed=1  and class_type = "+class_type +" limit " + offset + "," + rows;
            ...
            if (StringUtil.isEmpty(startDate)) {
                ...
                if (StringUtil.isNotEmpty(name)) {
                    ...
                    if (StringUtil.isNotEmpty(course_id) && StringUtil.isEmpty(subject)) {
                        //条件查询为course_id
                        sql =" where payed=1 and class_type = "+class_type +" and course_id = " + course_id + " and name = \'" + name +"\' limit " + offset + "," + rows;
                    } else if (StringUtil.isEmpty(course_id) && StringUtil.isNotEmpty(subject)) {
                        //subject
                        sql =  " where payed=1 and class_type = "+class_type +" and subject = \'" + subject + "\' and name = \'" + name+ "\' limit " + offset + "," + rows;
                    } else if (StringUtil.isNotEmpty(course_id) && StringUtil.isNotEmpty(subject)) {
                        sql =  " where payed=1 and class_type = "+class_type +" and subject = \'" + subject + "\' and course_id = " + course_id + " and name = \'" + name+ "\' limit " + offset + "," + rows;
                    } else if (StringUtil.isEmpty(course_id) && StringUtil.isEmpty(subject)) {
                        sql =  " where payed=1 and class_type = "+class_type +" and name = \'" + name+ "\' limit " + offset + "," + rows;
                    }
                }else{
                    //name为空
                    if (StringUtil.isNotEmpty(course_id) && StringUtil.isEmpty(subject)) {
                        //条件查询为course_id
                        sql =" where payed=1 and class_type = "+class_type +" and course_id = " + course_id + " limit " + offset + "," + rows;
                    } else if (StringUtil.isEmpty(course_id) && StringUtil.isNotEmpty(subject)) {
                        //subject
                        sql =  " where payed=1 and class_type = "+class_type +" and subject = \'" + subject + "\' limit " + offset + "," + rows;
                    } else if (StringUtil.isNotEmpty(course_id) && StringUtil.isNotEmpty(subject)) {
                        sql =  " where payed=1 and class_type = "+class_type +" and subject = \'" + subject + "\' and course_id = " + course_id + " limit " + offset + "," + rows;
                    }
                }

            } else {
                //有日期筛选
                sql = " where payed=1 and class_type = "+class_type +" "+" AND order_time BETWEEN "+ startDate  +" AND "+ endDate+" limit " + offset + "," + rows;
                if (StringUtil.isNotEmpty(name)) {
                    //name不为空
                    if (StringUtil.isNotEmpty(course_id) && StringUtil.isEmpty(subject)) {
                        //条件查询为course_id
                        sql =" where payed=1 and class_type = "+class_type +" and course_id = " + course_id+" AND order_time BETWEEN "+ startDate  +" AND "+ endDate + " and name = \'" + name +"\' limit " + offset + "," + rows;
                    } else if (StringUtil.isEmpty(course_id) && StringUtil.isNotEmpty(subject)) {
                        //subject
                        sql =  " where payed=1 and class_type = "+class_type +" "+" AND order_time BETWEEN "+ startDate  +" AND "+ endDate+" and subject = \'" + subject + "\' and name = \'" + name+ "\' limit " + offset + "," + rows;
                    } else if (StringUtil.isNotEmpty(course_id) && StringUtil.isNotEmpty(subject)) {
                        sql =  " where payed=1 and class_type ="+class_type +" "+" AND order_time BETWEEN "+ startDate  +" AND "+ endDate+" and subject = \'" + subject + "\' and course_id = " + course_id + " and name = \'" + name+ "\' limit " + offset + "," + rows;
                    } else if (StringUtil.isEmpty(course_id) && StringUtil.isEmpty(subject)) {
                        sql =  " where payed=1 and class_type = "+class_type +""+" AND order_time BETWEEN "+ startDate  +" AND "+ endDate+" and name = \'" + name+ "\' limit " + offset + "," + rows;
                    }
                }else{
                    //name为空
                    if (StringUtil.isNotEmpty(course_id) && StringUtil.isEmpty(subject)) {
                        //条件查询为course_id
                        sql =" where payed=1 and class_type = "+class_type +""+" AND order_time BETWEEN "+ startDate  +" AND "+ endDate+" and course_id = " + course_id + " limit " + offset + "," + rows;
                    } else if (StringUtil.isEmpty(course_id) && StringUtil.isNotEmpty(subject)) {
                        //subject
                        sql =  " where payed=1 and class_type = "+class_type +"  "+" AND order_time BETWEEN "+ startDate  +" AND "+ endDate+" and subject = \'" + subject + "\' limit " + offset + "," + rows;
                    } else if (StringUtil.isNotEmpty(course_id) && StringUtil.isNotEmpty(subject)) {
                        sql =  " where payed=1 and class_type = "+class_type +""+" AND order_time BETWEEN "+ startDate  +" AND "+ endDate+" and subject = \'" + subject + "\' and course_id = " + course_id + " limit " + offset + "," + rows;
                    }
                }
            }
        }
