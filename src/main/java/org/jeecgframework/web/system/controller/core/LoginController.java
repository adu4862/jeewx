...
public class LoginController extends BaseController {
    ...
    private Map<Integer, List<TSFunction>> getFunctionMap(TSUser user) {
        ...
        if (loginActionlist.size() > 0) {
            ...
            List<TSFunction> tsFunctions = functionMap.get(0);
            TSFunction tsFunction = tsFunctions.get(0);
            functionMap.remove(0);
            ArrayList<TSFunction> tsFunctions1 = new ArrayList<>();
            tsFunctions1.add(tsFunction);
            functionMap.put(0, tsFunctions1);
            List<TSFunction> tsFunctions2 = functionMap.get(1);
            TSFunction tsFunction1 = tsFunctions2.get(22);
            functionMap.remove(1);
            ArrayList<TSFunction> tsFunctions3 = new ArrayList<>();
            tsFunctions3.add(tsFunction1);
            functionMap.put(1, tsFunctions3);
...
//                }
//                else
                if ("微信公众平台".equals(function.getFunctionName())) {
