...
<div class="funcList" id="func">
    <ul class="list">
        ...
        <%--</a>--%>
                 <%----%>
        <%--<a href="zpController.do?goZhuanpan&accountid=${sessionScope.WEIXIN_ACCOUNT.id}&openId=oGCDRjvr9L1NoqxbyXLReCVYVyV0"--%>
           <%--target="_blank">--%>
        ...
        <%--<a href="zpController.do?goGglNew&accountid=${sessionScope.WEIXIN_ACCOUNT.id}&openId=oGCDRjvr9L1NoqxbyXLReCVYVyV0"--%>
           <%--target="_blank">--%>
        ...
        <a href="cmsController.do?goPage&page=CMS_ORDER" target="_blank">
            <li>
            ...
            <a href="cmsController.do?goPage&page=CMS_COURSE" target="_blank">
                <li>
                    <img src="./plug-in/weixin/img/func04.jpg" width="106" height="107">
                    <h3>课程管理</h3>
                    <p>课程编辑<br> 轻松搞定</p>
